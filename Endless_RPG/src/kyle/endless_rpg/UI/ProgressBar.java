...
public class ProgressBar extends Table{
   ...
   protected float min, max, stepSize,w, h;
   ...
   public ProgressBar (float min, float max, float stepSize, boolean vertical, Skin skin, float w, float h) {
      this(min, max, stepSize, vertical, skin.get("default-" + (vertical ? "vertical" : "horizontal"), ProgressBarStyle.class), w, h);
   }

   public ProgressBar (float min, float max, float stepSize, boolean vertical, Skin skin, String styleName, float w, float h) {
      this(min, max, stepSize, vertical, skin.get(styleName, ProgressBarStyle.class), w, h);
   }
   ...
   public ProgressBar (float min, float max, float stepSize, boolean vertical, ProgressBarStyle style, float w, float h) {
   ...
   static public class ProgressBarStyle {
      ...
      public ProgressBarStyle(Texture backgroundRegion, Texture progressRegion, float minHeight){
    	  TextureRegionDrawable drawBackground = new TextureRegionDrawable();
    	  TextureRegionDrawable drawProgress = new TextureRegionDrawable();
    	  TextureRegion background = new TextureRegion(backgroundRegion);
    	  TextureRegion progress = new TextureRegion(progressRegion);
    	  drawBackground.setRegion(background);
    	  drawBackground.setMinHeight(minHeight);
    	  drawProgress.setRegion(progress);
    	  drawProgress.setMinHeight(minHeight);
    	  this.background = drawBackground;
    	  this.progress = drawProgress;
      }
